...
# filename = '20221023d213235tUTC_Hershey_MovingDotsFullField_2pRAMsp_fov1p46x1p46_res2umpx_somemovement.log'
# pf = r'F:\Santiago\Analysis\Hershey\20221023d\SP_SiteB_WD20mm_100umdeep_1p46by1p46mm_2umppix_6p36Hz_50mW\suite2p\plane0/'


# filename = '20221023d214340tUTC_Hershey_MovingDotsFullField_2pRAMsp_fov0p73x0p73_res1umpx.log'
# pf = r'F:\Santiago\Analysis\Hershey\20221023d\SP_SiteC_WD20mm_100umdeep_0p73by0p73mm_1umppix_6p36Hz_50mW\suite2p\plane0/'

filename = '20221023d221230tUTC_Hershey_MovingDotsFullField_2pRAMsp_fov0p73x0p73_res1umpx.log'
pf = r'F:\Santiago\Analysis\Hershey\20221023d\SP_SiteD_WD20mm_200umdeep_0p73by0p73mm_1umppix_6p36Hz_70mW\suite2p\plane0/'

acq_framerate = 6.36
stimframes = int(np.ceil(2 * acq_framerate))
 
#filename = '20220823d192917tUTC_Coconut_Auditory_fov0p6x0p6.log'
#filename = '20220822d195227tUTC_Coconut_Auditory.log'
#filename = '20220822d184532tUTC_Coconut_Auditory.log'

#pf = 'F:/Santiago/Temp/20220822d_Coconut_450umdeep_0p6by0.6mm_fr9p61_1umperpix_90pct_Max30_stim_00002_plane_mosaic/cavB/suite2p/plane0/'
#pf = 'F:/Santiago/TempSuite2p/suite2p/plane0/' # single strip
#pf = 'F:/Santiago/Temp/20220823d_Coconut_Plane15atSurface_2by2mm_fr6p45_2p75umperpix_100pct_Max15_stim_00001_plane_mosaic/suite2p/plane0/'
...
for r in range(Frois.shape[0]):
   ...
   # plt.tight_layout()
    ...
    for c in range(cond_num):
        ...
        plt.subplot(2, 4, c+1)
        plt.title('Stimulus: ' + str(conds[c]) + 'degrees', fontsize = 9)
